...
def emr_post():
   ...
   rtn_dict = {
     "ClusterId": cid,
     "CheckClusterStatus": ("http://ec2-18-191-50-79.us-east-2.compute.amazonaws.com:8081/api/emr?" + cid),
     "TerminateCluster": ('curl -X "DELETE" http://ec2-18-191-50-79.us-east-2.compute.amazonaws.com:8081/api/emr?' + cid)
   }
